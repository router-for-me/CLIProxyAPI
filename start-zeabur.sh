...
# This script creates a config.yaml that uses Zeabur's PORT environment variable

set -e

# Zeabur injects PORT, use it or default to 8080
LISTEN_PORT="${PORT:-8080}"

echo "=== Zeabur Environment Debug ==="
echo "PORT env: ${PORT}"
...
# Auto-generated config for Zeabur deployment
host: ""
port: ${LISTEN_PORT}

# API keys (set via Zeabur environment variables)
api-keys:
