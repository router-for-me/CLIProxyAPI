...
func responsesSourceFormat(c *gin.Context) string {
	if c != nil && c.Request != nil && handlers.HasNativeCodexClientHeaders(c.Request.Header) {
		return Codex
	}
	return OpenaiResponse
}
...
func (h *OpenAIResponsesAPIHandler) Compact(c *gin.Context) {
	...
	resp, upstreamHeaders, errMsg := h.ExecuteWithAuthManager(cliCtx, responsesSourceFormat(c), modelName, rawJSON, "responses/compact")
	stopKeepAlive()
	if errMsg != nil {
...
func (h *OpenAIResponsesAPIHandler) handleNonStreamingResponse(c *gin.Context, rawJSON []byte) {
	...
	resp, upstreamHeaders, errMsg := h.ExecuteWithAuthManager(cliCtx, responsesSourceFormat(c), modelName, rawJSON, "")
	stopKeepAlive()
	if errMsg != nil {
		h.WriteErrorResponse(c, errMsg)
		cliCancel(errMsg.Error)
...
func (h *OpenAIResponsesAPIHandler) handleStreamingResponse(c *gin.Context, rawJSON []byte) {
	...
	modelName := gjson.GetBytes(rawJSON, "model").String()
	cliCtx, cliCancel := h.GetContextWithCancel(h, c, context.Background())
	dataChan, upstreamHeaders, errChan := h.ExecuteStreamWithAuthManager(cliCtx, responsesSourceFormat(c), modelName, rawJSON, "")
