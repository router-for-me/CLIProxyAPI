...
var zhStrings = map[string]string{
	...
	// ── Auth Files ──
	"auth_title":             "🔑 认证文件",
	"auth_help1":             " [↑↓/jk] 导航 • [Enter] 展开 • [a] 添加 • [e] 启用/停用 • [d] 删除 • [r] 刷新",
	"auth_help2":             " [1] 编辑 prefix • [2] 编辑 proxy_url • [3] 编辑 priority",
	"no_auth_files":          "  无认证文件",
	"auth_add_prompt":        "  输入要上传的认证 JSON 文件路径：",
	"auth_add_help":          "Enter: 上传 • Esc: 取消",
	"auth_add_path_required": "请输入认证文件路径",
...
var enStrings = map[string]string{
	...
	"auth_help1":             " [↑↓/jk] Navigate • [Enter] Expand • [a] Add • [e] Enable/Disable • [d] Delete • [r] Refresh",
	"auth_help2":             " [1] Edit prefix • [2] Edit proxy_url • [3] Edit priority",
	"no_auth_files":          "  No auth files found",
	"auth_add_prompt":        "  Enter auth JSON file path to upload:",
	"auth_add_help":          "Enter: Upload • Esc: Cancel",
	"auth_add_path_required": "auth file path is required",
...
var faStrings = map[string]string{
	...
	"auth_help1":             " [↑↓/jk] جابجایی • [Enter] بازکردن • [a] افزودن • [e] فعال/غیرفعال • [d] حذف • [r] بازخوانی",
	"auth_help2":             " [1] ویرایش prefix • [2] ویرایش proxy_url • [3] ویرایش priority",
	"no_auth_files":          "  فایل احراز هویت یافت نشد",
	"auth_add_prompt":        "  مسیر فایل JSON احراز هویت را برای بارگذاری وارد کنید:",
	"auth_add_help":          "Enter: بارگذاری • Esc: لغو",
	"auth_add_path_required": "مسیر فایل احراز هویت الزامی است",
	"confirm_delete":         "⚠ حذف %s؟ [y/n]",
	"deleted":                "%s حذف شد",
	"uploaded":               "%s بارگذاری شد",
	"enabled":                "فعال شد",
	"disabled":               "غیرفعال شد",
