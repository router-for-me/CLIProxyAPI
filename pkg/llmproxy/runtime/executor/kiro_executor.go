...
func (e *KiroExecutor) callKiroAndBuffer(
	...
	kiroStream, err := e.executeStreamWithRetry(
		ctx, auth, req, opts, accessToken, effectiveProfileArn, body, from, nil, kiroModelID, isAgentic, isChatOnly, tokenKey,
	)
	if err != nil {
		return nil, err
	}
...
func (e *KiroExecutor) callKiroDirectStream(
	...
	stream, streamErr := e.executeStreamWithRetry(
		ctx, auth, req, opts, accessToken, effectiveProfileArn, body, from, reporter, kiroModelID, isAgentic, isChatOnly, tokenKey,
	)
