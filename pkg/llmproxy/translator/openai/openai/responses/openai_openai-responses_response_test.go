...
<<<<<<< HEAD:pkg/llmproxy/translator/openai/openai/responses/openai_openai-responses_response_test.go
...
>>>>>>> upstream/main:internal/translator/openai/openai/responses/openai_openai-responses_response_test.go
	}
}
