...
// MCP/WebSearch request and response types are defined in kiro_websearch.go.
// This file owns the HTTP handler, fetch lifecycle, and MCP API call.

// Tool description fetch state.
...
// GetWebSearchDescription is defined in kiro_websearch.go.
