...
<<<<<<< HEAD:pkg/llmproxy/translator/claude/openai/responses/claude_openai-responses_response_test.go
...
>>>>>>> upstream/main:internal/translator/claude/openai/responses/claude_openai-responses_response_test.go
	}
}
