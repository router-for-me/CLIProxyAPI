...
- `model-sequence-router/`: Go-only ModelRouter + ModelRegistrar that advances each conversation through an ordered cross-provider model sequence. See `model-sequence-router/README.md`.
