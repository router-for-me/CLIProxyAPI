...
func main() {
	...
	flag.StringVar(&kiroSSOToken, "kiro-sso-token", "", "Import Kiro/AWS SSO token JSON file")
	...
	} else if strings.TrimSpace(kiroSSOToken) != "" {
		cmd.DoKiroSSOTokenImport(cfg, options, kiroSSOToken)
	} else {
