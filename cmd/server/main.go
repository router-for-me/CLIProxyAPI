...
func main() {
	...
	flag.BoolVar(&cursorLogin, "cursor-login", false, "Login to Cursor using deep-link OAuth")
	...
	commandMode := vertexImport != "" || antigravityLogin || codexLogin || codexDeviceLogin || claudeLogin || kimiLogin || cursorLogin || xaiLogin
