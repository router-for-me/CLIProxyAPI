...
func GetGitHubCopilotModels() []*ModelInfo {
	...
	models = append(models, []*ModelInfo{
		...
		},
		{
			...
			Description:         "OpenAI GPT-5 Codex low reasoning mode via GitHub Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 32768,
			SupportedEndpoints:  []string{"/responses"},
			Thinking:            &ThinkingSupport{Levels: []string{"low"}},
		},
		{
			...
			Description:         "OpenAI GPT-5 Codex medium reasoning mode via GitHub Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 32768,
			SupportedEndpoints:  []string{"/responses"},
		...
		},
		{
			...
			Description:         "OpenAI GPT-5 Codex high reasoning mode via GitHub Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 32768,
			SupportedEndpoints:  []string{"/responses"},
