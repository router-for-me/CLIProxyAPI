...
type Server struct {
	...
	requestLogPolicy *logging.RequestLogPolicy
	loggerToggle     func(bool)

	managementHTMLCache managementHTMLAssetCache
...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	requestLogPolicy := logging.NewRequestLogPolicy(cfg.APIKeysNoLog)
	...
	if !cfg.CommercialMode {
		...
		if requestLogger != nil {
			engine.Use(middleware.RequestLoggingMiddleware(requestLogger, requestLogPolicy))
