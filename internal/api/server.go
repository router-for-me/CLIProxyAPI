...
func (s *Server) setupRoutes() {
	...
	// Codex CLI wire_api="responses" root path routes
	// When config.toml sets wire_api = "responses", requests go directly to /responses
	...
	// Codex CLI compatibility route: /models (without /v1 prefix)
