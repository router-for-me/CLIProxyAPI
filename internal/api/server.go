...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.PATCH("/api-key-quotas", s.mgmt.PatchAPIKeyQuotas)
		mgmt.GET("/api-key-quotas/enabled", s.mgmt.GetAPIKeyQuotasEnabled)
		mgmt.PUT("/api-key-quotas/enabled", s.mgmt.PutAPIKeyQuotasEnabled)
		mgmt.PATCH("/api-key-quotas/enabled", s.mgmt.PutAPIKeyQuotasEnabled)
		mgmt.GET("/api-key-quotas/exclude-model-patterns", s.mgmt.GetAPIKeyQuotaExcludeModelPatterns)
		mgmt.PUT("/api-key-quotas/exclude-model-patterns", s.mgmt.PutAPIKeyQuotaExcludeModelPatterns)
		mgmt.PATCH("/api-key-quotas/exclude-model-patterns", s.mgmt.PatchAPIKeyQuotaExcludeModelPatterns)
		mgmt.DELETE("/api-key-quotas/exclude-model-patterns", s.mgmt.DeleteAPIKeyQuotaExcludeModelPatterns)
		mgmt.GET("/api-key-quotas/monthly-token-limits", s.mgmt.GetAPIKeyQuotaMonthlyTokenLimits)
		mgmt.PUT("/api-key-quotas/monthly-token-limits", s.mgmt.PutAPIKeyQuotaMonthlyTokenLimits)
		mgmt.PATCH("/api-key-quotas/monthly-token-limits", s.mgmt.PatchAPIKeyQuotaMonthlyTokenLimits)
		mgmt.DELETE("/api-key-quotas/monthly-token-limits", s.mgmt.DeleteAPIKeyQuotaMonthlyTokenLimits)
