...
func (s *Server) registerManagementRoutes() {
    ...
    mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
    {
        ...
        mgmt.GET("/intelligent-routing/stats", s.mgmt.GetIntelligentRoutingStats)
        mgmt.GET("/intelligent-routing/config", s.mgmt.GetIntelligentRoutingConfig)
        mgmt.PUT("/intelligent-routing/config", s.mgmt.UpdateIntelligentRoutingConfig)
        mgmt.PATCH("/intelligent-routing/config", s.mgmt.UpdateIntelligentRoutingConfig)
