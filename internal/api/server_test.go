...
func TestModelsWithClientVersionReturnsCodexCatalog(t *testing.T) {
	...
	// fork: upstream v7.2.61 ships this assertion stale at 129; the actual catalog
	// priority (basePriority + 100*(rank+1)) is 143 after upstream's own model additions.
