...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/codex-client-models", s.mgmt.GetCodexClientModels)
		mgmt.PUT("/codex-client-models/override", s.mgmt.PutCodexClientModelsOverride)
		mgmt.DELETE("/codex-client-models/override", s.mgmt.DeleteCodexClientModelsOverride)
		mgmt.PUT("/codex-client-models/override/:slug", s.mgmt.PutCodexClientModelsOverrideEntry)
		mgmt.DELETE("/codex-client-models/override/:slug", s.mgmt.DeleteCodexClientModelsOverrideEntry)
