...
type Handler struct {
	...
	sqlitePlugin        *usage.SQLitePlugin // optional SQLite persistence
...
// SetSQLitePlugin sets the SQLite plugin for usage persistence.
func (h *Handler) SetSQLitePlugin(plugin *usage.SQLitePlugin) { h.sqlitePlugin = plugin }
