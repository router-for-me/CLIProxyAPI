...
// SetCopilotService registers the Copilot quota service with the management handler.
func (h *Handler) SetCopilotService(svc *copilot.Service) {
	h.copilotService = svc
}
