...
// SetAccountPoolStore attaches an account pool store for account management endpoints.
func (h *Handler) SetAccountPoolStore(s *accountpool.Store) {
	h.accountPool = s
}
