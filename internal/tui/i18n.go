...
var zhStrings = map[string]string{
	...
	// ── Cache ──
	"cache_title":              "🧊 提示缓存",
	"cache_help":               " [↑↓/jk] 导航 • [Enter] 会话详情 • [p] 切换提供商筛选 • [r] 刷新",
	...
	"cache_probe_yes":          "是",
	"cache_probe_no":           "-",
	"cache_provider_filter":    "提供商",
	"cache_filter_all":         "全部",
	"cache_by_provider":        "分提供商统计",
	"cache_no_cache_data":      "该提供商未上报缓存数据",
	"cache_classified_fmt":     "(%d/%d 已分类)",
	"cache_rebinds":            "换绑",
	"cache_t0_breakdown":       "T0 归因",
	"cache_t0_first":           "首次",
	"cache_t0_rebind":          "换绑",
	"cache_t0_expiry":          "过期",
	"cache_cached_share":       "缓存占比",
	"cache_prompt_tokens":      "提示 Tokens",
	"cache_signal":             "缓存信号",
	"cache_signal_full":        "full (读取+写入)",
	"cache_signal_read":        "read (仅读取)",
	"cache_signal_none":        "none (无缓存数据)",
	"cache_keyed_by":           "会话标识方式",
	"cache_keyed_session":      "session (真实会话)",
	"cache_keyed_apikey_model": "apikey-model (按密钥+模型聚合)",
	"cache_keyed_legend":       "  † = 按 API 密钥 + 模型聚合，并非真实会话",
	"cache_alerting":           "⚠ 缓存持续丢失告警",
	"cache_alert_legend":       "! = 一小时滑动窗口内持续丢失缓存",
	"cache_lost_in_window":     "窗口内丢失 (1h)",
	"cache_tier_legend":        "  ✗ 未命中 • ○ T0 (过期/首次) • ⇄ T0 换绑，缓存在另一凭证上，并非丢失 • · n/a 无缓存数据",
	"cache_col_provider":       "提供商",
	"cache_col_share":          "占比",
	"cache_col_rebinds":        "换绑",
	"cache_col_rebind":         "换绑",
	"cache_col_prompt":         "提示",
...
var enStrings = map[string]string{
	...
	"cache_help":               " [↑↓/jk] Navigate • [Enter] Session detail • [p] Provider filter • [r] Refresh",
	...
	"cache_probe_yes":          "yes",
	"cache_probe_no":           "-",
	"cache_provider_filter":    "provider",
	"cache_filter_all":         "all",
	"cache_by_provider":        "By Provider",
	"cache_no_cache_data":      "provider reports no cache data",
	"cache_classified_fmt":     "(%d/%d classified)",
	"cache_rebinds":            "rebinds",
	"cache_t0_breakdown":       "T0 Causes",
	"cache_t0_first":           "first",
	"cache_t0_rebind":          "rebind",
	"cache_t0_expiry":          "expiry",
	"cache_cached_share":       "Cached Share",
	"cache_prompt_tokens":      "prompt tokens",
	"cache_signal":             "Cache Signal",
	"cache_signal_full":        "full (reads + creations)",
	"cache_signal_read":        "read (reads only)",
	"cache_signal_none":        "none (no cache data)",
	"cache_keyed_by":           "Keyed By",
	"cache_keyed_session":      "session (real session)",
	"cache_keyed_apikey_model": "apikey-model (grouped by key + model)",
	"cache_keyed_legend":       "  † = keyed by API key + model, not a real session",
	"cache_alerting":           "⚠ SUSTAINED CACHE LOSS",
	"cache_alert_legend":       "! = sustained cache loss in the last 1h window",
	"cache_lost_in_window":     "Lost in Window (1h)",
	"cache_tier_legend":        "  ✗ miss • ○ T0 (expiry/first) • ⇄ T0 rebind: cache alive on another credential, not lost • · n/a no cache data",
	"cache_col_provider":       "PROVIDER",
	"cache_col_share":          "SHARE",
	"cache_col_rebinds":        "RBND",
	"cache_col_rebind":         "RB",
	"cache_col_prompt":         "PROMPT",
