...
// Tab names
// ──────────────────────────────────────────
var zhTabNames = []string{"仪表盘", "配置", "认证文件", "API 密钥", "OAuth", "缓存", "日志"}
var enTabNames = []string{"Dashboard", "Config", "Auth Files", "API Keys", "OAuth", "Cache", "Logs"}
...
var zhStrings = map[string]string{
	...
	// ── Cache ──
	"cache_title":            "🧊 提示缓存",
	"cache_help":             " [↑↓/jk] 导航 • [Enter] 查看会话详情 • [r] 刷新",
	"cache_detail_title":     "🧊 缓存会话详情",
	"cache_detail_help":      " [Esc] 返回列表 • [↑↓/jk] 滚动 • [r] 刷新",
	"cache_overview":         "全局概览",
	"cache_disabled":         "⚠ 缓存统计未启用",
	"cache_unreachable":      "  无法获取缓存统计，请确认服务正在运行。",
	"cache_no_sessions":      "  暂无缓存会话",
	"cache_no_requests":      "  该会话暂无请求记录",
	"cache_loading_session":  "  正在加载会话详情...",
	"cache_hit_rate":         "命中率",
	"cache_requests":         "请求数",
	"cache_breakdown":        "明细",
	"cache_hits":             "命中",
	...
	"cache_lost_tokens":      "丢失 Tokens",
	"cache_creation_split":   "缓存写入 5m/1h",
	"cache_total":            "合计",
	"cache_dominant":         "主导",
	"cache_regime":           "缓存周期",
	"cache_regime_none":      "无",
	"cache_regime_even":      "持平",
	"cache_sessions_section": "会话列表",
	"cache_sessions_count":   "会话数",
	"cache_last_activity":    "最近活动",
	"cache_auth":             "认证 ID",
	"cache_sequence":         "请求序列",
	"cache_ago_fmt":          "%s前",
	"cache_probe_yes":        "是",
	"cache_probe_no":         "-",
	"cache_col_session":      "会话",
	"cache_col_model":        "模型",
	"cache_col_requests":     "请求",
	"cache_col_hitrate":      "命中率",
	"cache_col_misses":       "未命中",
	"cache_col_t0":           "T0",
	"cache_col_lost":         "丢失",
	"cache_col_last_seen":    "最近",
	"cache_col_seq":          "#",
	"cache_col_ago":          "时间",
	"cache_col_read":         "读取",
	"cache_col_c5m":          "写5m",
...
var enStrings = map[string]string{
	...
	// ── Cache ──
	"cache_title":            "🧊 Prompt Cache",
	"cache_help":             " [↑↓/jk] Navigate • [Enter] Session detail • [r] Refresh",
	"cache_detail_title":     "🧊 Cache Session Detail",
	"cache_detail_help":      " [Esc] Back to list • [↑↓/jk] Scroll • [r] Refresh",
	"cache_overview":         "Global Overview",
	"cache_disabled":         "⚠ Cache statistics are disabled",
	"cache_unreachable":      "  Cache stats unavailable. Is the server running?",
	"cache_no_sessions":      "  No cache sessions recorded yet",
	"cache_no_requests":      "  No requests recorded for this session",
	"cache_loading_session":  "  Loading session detail...",
	...
	"cache_lost_tokens":      "Lost Tokens",
	"cache_creation_split":   "Cache Creation 5m/1h",
	"cache_total":            "total",
	"cache_dominant":         "dominant",
	"cache_regime":           "Regime",
	"cache_regime_none":      "none",
	"cache_regime_even":      "even",
	"cache_sessions_section": "Sessions",
	"cache_sessions_count":   "Sessions",
	"cache_last_activity":    "Last Activity",
	"cache_auth":             "Auth ID",
	"cache_sequence":         "Request Sequence",
	"cache_ago_fmt":          "%s ago",
	"cache_probe_yes":        "yes",
	"cache_probe_no":         "-",
	"cache_col_session":      "SESSION",
	"cache_col_model":        "MODEL",
	"cache_col_requests":     "REQ",
	"cache_col_hitrate":      "HIT%",
	"cache_col_misses":       "MISS",
	"cache_col_t0":           "T0",
	"cache_col_lost":         "LOST",
	"cache_col_last_seen":    "LAST SEEN",
	"cache_col_seq":          "#",
	"cache_col_ago":          "AGO",
	"cache_col_read":         "READ",
	"cache_col_c5m":          "CR-5M",
	"cache_col_c1h":          "CR-1H",
	"cache_col_tier":         "TIER",
	"cache_col_reason":       "MISS REASON",
	"cache_col_probe":        "PROBE",
