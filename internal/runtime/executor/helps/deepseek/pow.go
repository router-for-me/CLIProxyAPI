...
func keccakF23(s *[25]uint64) {
	...
	for r := 1; r < 24; r++ {
		...
		d0 := c4 ^ rotateLeft64(c1, 1)
		d1 := c0 ^ rotateLeft64(c2, 1)
		d2 := c1 ^ rotateLeft64(c3, 1)
		d3 := c2 ^ rotateLeft64(c4, 1)
		d4 := c3 ^ rotateLeft64(c0, 1)
		a0 ^= d0
		a5 ^= d0
		a10 ^= d0
		a15 ^= d0
		...
		b0 := a0
		b10 := rotateLeft64(a1, 1)
		b20 := rotateLeft64(a2, 62)
		b5 := rotateLeft64(a3, 28)
		b15 := rotateLeft64(a4, 27)
		b16 := rotateLeft64(a5, 36)
		b1 := rotateLeft64(a6, 44)
		b11 := rotateLeft64(a7, 6)
		b21 := rotateLeft64(a8, 55)
		b6 := rotateLeft64(a9, 20)
		b7 := rotateLeft64(a10, 3)
		b17 := rotateLeft64(a11, 10)
		b2 := rotateLeft64(a12, 43)
		b12 := rotateLeft64(a13, 25)
		b22 := rotateLeft64(a14, 39)
		b23 := rotateLeft64(a15, 41)
		b8 := rotateLeft64(a16, 45)
		b18 := rotateLeft64(a17, 15)
		b3 := rotateLeft64(a18, 21)
		b13 := rotateLeft64(a19, 8)
		b14 := rotateLeft64(a20, 18)
		b24 := rotateLeft64(a21, 2)
		b9 := rotateLeft64(a22, 61)
		b19 := rotateLeft64(a23, 56)
		b4 := rotateLeft64(a24, 14)
...
func SolveAndBuildPowHeader(ctx context.Context, challenge PowChallenge) (string, error) {
	if challenge.Algorithm != "DeepSeekHashV1" {
		return "", errors.New("pow: unsupported algorithm: " + challenge.Algorithm)
	}
	difficulty := challenge.Difficulty
	if difficulty <= 0 {
		difficulty = 144000
	}
	answer, err := SolvePow(ctx, challenge.Challenge, challenge.Salt, challenge.ExpireAt, difficulty)
	if err != nil {
		return "", err
	}
