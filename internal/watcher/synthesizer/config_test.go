...
func TestConfigSynthesizer_AWSBedrockKeys_ProxyPriorityAndExcludedModels(t *testing.T) {
	...
	if auth.Attributes["region"] != "us-east-1" {
		t.Fatalf("region = %q, want %q", auth.Attributes["region"], "us-east-1")
	}
	if auth.Attributes["base_url"] != "https://bedrock-runtime.us-east-1.amazonaws.com" {
		t.Fatalf("base_url = %q, want %q", auth.Attributes["base_url"], "https://bedrock-runtime.us-east-1.amazonaws.com")
	}
