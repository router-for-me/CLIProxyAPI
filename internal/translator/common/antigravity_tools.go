...
// read_file / write_file. When a client-defined function re-declares one of
// those names, Google returns 500 "Unknown Error". The proxy therefore renames
...
// upstream tool name before it reaches the client. Non-prefixed names pass
// through unchanged.
