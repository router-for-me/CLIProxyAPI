...
// HasStrictValidatorIncompatiblePattern reports whether a regular expression string
// uses a construct that strict upstream JSON Schema validators reject when they
// compile "pattern" values on the way to a provider.
//
...
func HasStrictValidatorIncompatiblePattern(pattern string) bool {
