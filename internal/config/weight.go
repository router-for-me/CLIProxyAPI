...
func validateCredentialWeightYAML(data []byte) error {
	...
	families := map[string]struct{}{
		...
		"vertex-api-key": {}, "codex-api-key": {}, "xai-api-key": {}, "kimi-api-key": {},
	}
...
func (cfg *Config) ValidateCredentialWeights() error {
	...
	for index := range cfg.KimiKey {
		if errValidate := ValidateCredentialWeight(cfg.KimiKey[index].Weight); errValidate != nil {
			return fmt.Errorf("kimi-api-key[%d].weight: %w", index, errValidate)
		}
	}
