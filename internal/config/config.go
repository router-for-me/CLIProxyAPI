...
type RoutingConfig struct {
	...
	// ProviderStrategies optionally overrides the global strategy for specific providers.
	// Keys are provider names (e.g. "claude", "codex"), values are strategy names.
	// Unspecified providers fall back to Strategy.
	ProviderStrategies map[string]string `yaml:"provider_strategies,omitempty" json:"provider_strategies,omitempty"`
}
