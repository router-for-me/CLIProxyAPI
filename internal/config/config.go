...
type Config struct {
	...
	// KimiKey defines native Kimi API key configurations.
	KimiKey []KimiKey `yaml:"kimi-api-key" json:"kimi-api-key"`
	...
	// gemini-api-key, interactions-api-key, codex-api-key, xai-api-key, kimi-api-key, claude-api-key, openai-compatibility, and vertex-api-key.
