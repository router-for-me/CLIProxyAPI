...
import "github.com/router-for-me/CLIProxyAPI/v7/internal/billing"
...
type Config struct {
	...
	// Billing configures API-equivalent usage accounting, user tokens, quota, and rate limiting.
	Billing billing.Config `yaml:"billing" json:"billing"`
