...
type Config struct {
    ...
    // IntelligentRouting enables intelligent model routing based on quota and usage patterns.
    IntelligentRouting IntelligentRoutingConfig `yaml:"intelligent-routing" json:"intelligent-routing"`
}
...
// IntelligentRoutingConfig holds configuration for intelligent routing features.
type IntelligentRoutingConfig struct {
    // Enabled toggles intelligent routing on or off. When disabled, uses round-robin.
    Enabled bool `yaml:"enabled" json:"enabled"`
    // StatsRetentionHours defines how long to keep usage statistics (in hours).
    StatsRetentionHours int `yaml:"stats-retention-hours" json:"stats-retention-hours"`
    // CleanupIntervalMinutes defines how often to clean up old statistics (in minutes).
    CleanupIntervalMinutes int `yaml:"cleanup-interval-minutes" json:"cleanup-interval-minutes"`
}
