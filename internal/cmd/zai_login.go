...
// DoZAILogin triggers the ZCode CLI OAuth flow for Z.AI / BigModel coding plans
// and saves the resulting credentials. The provider selects the identity
// provider: "zai" (international) or "bigmodel" (China mainland).
//
// Parameters:
//   - cfg: The application configuration containing proxy and auth directory settings
//   - options: Login options including browser behavior settings
//   - provider: Identity provider, "zai" or "bigmodel" (defaults to "zai")
