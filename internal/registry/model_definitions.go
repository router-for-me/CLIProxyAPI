...
func GetGeminiModels() []*ModelInfo {
	return []*ModelInfo{
		...
		// TTS (Text-to-Speech) models
		{
			...
			Description:                "Text-to-speech model optimized for low latency, real-time applications. Supports 28 voices and 24 languages.",
		...
		},
		{
			...
			Description:                "Text-to-speech model optimized for quality and expressivity. Supports 28 voices and 24 languages.",
			InputTokenLimit:            32768,
			OutputTokenLimit:           8192,
			SupportedGenerationMethods: []string{"generateContent"},
		},
...
func GetAIStudioModels() []*ModelInfo {
	return []*ModelInfo{
		...
		// Native Audio model
		{
			...
			OutputTokenLimit:           8192,
			SupportedGenerationMethods: []string{"generateContent"},
			// Audio models don't support thinkingConfig; leave Thinking nil
		},
	}
}
