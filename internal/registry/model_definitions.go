...
func GetKiroModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Description:         "Claude Opus 4.6 via Kiro (2.2x credit, 1M context)",
			ContextLength:       1000000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 32000, ZeroAllowed: true, DynamicAllowed: true},
		},
		{
			...
			Description:         "Claude Sonnet 4.6 via Kiro (1.3x credit, 1M context)",
			ContextLength:       1000000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 32000, ZeroAllowed: true, DynamicAllowed: true},
		},
		...
		},
		{
			...
			Description:         "Claude Opus 4.6 optimized for coding agents (1M context, chunked writes)",
			ContextLength:       1000000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 32000, ZeroAllowed: true, DynamicAllowed: true},
		},
		{
			...
			Description:         "Claude Sonnet 4.6 optimized for coding agents (1M context, chunked writes)",
			ContextLength:       1000000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 32000, ZeroAllowed: true, DynamicAllowed: true},
		},
