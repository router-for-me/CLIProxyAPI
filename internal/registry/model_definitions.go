	...
	return []*ModelInfo{
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-4.1",
			Description:         "OpenAI GPT-4.1 via Copilot",
			ContextLength:       128000,
		...
		},
		{
			...
			Description:         "OpenAI GPT-5 Mini via Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-5 Codex",
			Description:         "OpenAI GPT-5 Codex via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 32768,
		},
		{
		...
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-5.1 Codex",
			Description:         "OpenAI GPT-5.1 Codex via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 32768,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-5.1 Codex Mini",
			Description:         "OpenAI GPT-5.1 Codex Mini via Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		{
			...
			Description:         "Anthropic Claude Haiku 4.5 via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Anthropic Claude Opus 4.1 via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 32000,
		},
		{
			...
			Description:         "Anthropic Claude Opus 4.5 via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Anthropic Claude Sonnet 4 via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Anthropic Claude Sonnet 4.5 via Copilot",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
		...
		},
		{
			...
			Description:         "Google Gemini 3 Pro via Copilot",
			ContextLength:       1048576,
			MaxCompletionTokens: 65536,
		},
		{
			...
			Description:         "xAI Grok Code Fast 1 via Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		{
			...
			Description:         "Raptor Mini via Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
	}
