...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			DisplayName:         "GPT 5.1",
			Description:         "GPT 5.1: Enhanced version with improved reasoning capabilities and default medium effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
		{
			...
			Description:         "GPT 5.1 with low reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
		{
			...
			Description:         "GPT 5.1 with medium reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
		...
		},
		{
			...
			Description:         "GPT 5.1 Codex: Enhanced version optimized for coding and agentic tasks.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
		{
			...
			Description:         "GPT 5.1 Codex with low reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
		{
			...
			Description:         "GPT 5.1 Codex with medium reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
		{
			...
			Description:         "GPT 5.1 Codex with high reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		},
