...
func applyCodexClientVisibilityOverride(entry map[string]any, id string) {
	...
	case "grok-imagine-image-quality", "gpt-image-1.5", "gpt-image-2", "grok-imagine-image", "grok-imagine-image-2.0", "grok-imagine-video", "grok-imagine-video-1.5", "grok-imagine-video-1.5-preview", "grok-tts":
		entry["visibility"] = "hide"
	}
}
