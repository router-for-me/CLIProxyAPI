...
<td>CLIProxyAPI をご支援いただいている <a href="https://apertis.ai/register?utm_source=cliproxyapi&amp;utm_medium=partner&amp;utm_campaign=cliproxyapi_partner">Apertis</a> に感謝します！Apertis はマルチプロバイダー AI API ゲートウェイで、CLIProxyAPI の <code>openai-compatibility</code> アップストリームとして利用でき、OpenAI と Anthropic SDK のストリーミングおよび非ストリーミングリクエストに対応しています。CLIProxyAPI ユーザーは専用リンクから登録し、Checkout 前に「Partner code」欄へプロモーションコード <code>CLIPROXYAPI</code> を入力すると、個人アカウントごとに 1 回、PAYG 購入または Coding Plan の Checkout が 10% 割引になります。特典は先着 100 回の利用に限られ、2026 年 10 月 20 日 08:18 UTC に終了します。<a href="https://apertis.ai/integrations/cliproxyapi">セットアップガイド</a>をご覧ください。</td>
</tr>
<tr>
